...
@section('content')
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-lg-3 col-6">
                <div class="small-box bg-success">
                    <div class="inner">
                        <h3>{{ number_format($chargesVariablesAnnee ?? 0, 0, ',', ' ') }}</h3>
                        <p>Total livraisons payées (année)</p>
                    </div>
                    <div class="icon">
            ...
            <div class="col-lg-3 col-6">
                <div class="small-box bg-warning">
                    <div class="inner">
                        <h3>{{ number_format($chargesFixesAnnee ?? 0, 0, ',', ' ') }}</h3>
                        <p>Dépenses Effectuées (année)</p>
                    </div>
                    <div class="icon">
            ...
            <div class="col-lg-3 col-6">
                <div class="small-box bg-danger">
                    <div class="inner">
                        <h3>{{ number_format($gainSyntheseAnnee ?? 0, 0, ',', ' ') }}</h3>
                        <p>Gain de l'année</p>
                    </div>
                    <div class="icon">
        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="ovl-kpi">
                    <div class="ovl-kpi-label">Colis Reçus (année)</div>
        ...
        <div class="row mt-3">
            <div class="col-12">
                <div class="ovl-panel-title">Comparaison mensuelle (année en cours)</div>
                <div class="ovl-panel-body">
                    <div style="height: 320px;">
                        <canvas id="ovlComparaisonMensuelleChart"></canvas>
                    </div>
                    <div class="mt-3">
                        <div class="d-flex justify-content-center align-items-center mb-2" style="gap: 30px;">
                            <div class="d-flex align-items-center"><span style="display:inline-block;width:14px;height:14px;background:#17a2b8;border-radius:3px;margin-right:8px;"></span> Colis reçus</div>
                            <div class="d-flex align-items-center"><span style="display:inline-block;width:14px;height:14px;background:#28a745;border-radius:3px;margin-right:8px;"></span> Gains (XOF)</div>
                            <div class="d-flex align-items-center"><span style="display:inline-block;width:14px;height:14px;background:#fd7e14;border-radius:3px;margin-right:8px;"></span> Dépenses (XOF)</div>
                        </div>
                        <div class="table-responsive">
                            <table class="table table-sm table-bordered text-center mb-0" style="font-size: 13px;">
                                ...
                                <tbody>
                                    <tr>
                                        <td style="background: #17a2b8; color: #fff; font-weight: 600;">Colis reçus</td>
                                        @foreach($colisRecusParMois ?? [] as $val)
                                            <td>{{ number_format($val, 0, ',', ' ') }}</td>
                                        @endforeach
                                    </tr>
                                    <tr>
                                        <td style="background: #28a745; color: #fff; font-weight: 600;">Gains</td>
                                        @foreach($gainsParMois ?? [] as $val)
                                            <td>{{ number_format($val, 0, ',', ' ') }}</td>
                                        @endforeach
                                    </tr>
                                    <tr>
                                        <td style="background: #fd7e14; color: #fff; font-weight: 600;">Dépenses</td>
                                        @foreach($depensesParMois ?? [] as $val)
                                            <td>{{ number_format($val, 0, ',', ' ') }}</td>
                                        @endforeach
                                    </tr>
                                </tbody>
    ...
    <script>
        (function () {
            var bootComparaison = function () {
                ...
                var moisLabels = @json($moisLabels ?? []);
                var colisRecusParMois = @json($colisRecusParMois ?? []);
                var gainsParMois = @json($gainsParMois ?? []);
                var depensesParMois = @json($depensesParMois ?? []);

                var comparaisonCanvas = document.getElementById('ovlComparaisonMensuelleChart');
                if (comparaisonCanvas && moisLabels.length) {
                    new Chart(comparaisonCanvas.getContext('2d'), {
                        type: 'bar',
                        data: {
                            labels: moisLabels,
                            datasets: [
